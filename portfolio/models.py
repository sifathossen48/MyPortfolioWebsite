...
class SiteInfo(models.Model):
    ...
    dribble = models.URLField(max_length=100, blank=True)
    pintarest = models.URLField(max_length=100, blank=True)
    more_website_name = models.CharField(max_length=50)
    website_link = models.URLField(max_length=100, blank=True)
